...
#update
#apt-get --assume-yes install libmicrohttpd-dev libssl-dev cmake build-essential libhwloc-dev screen git nano htop wget curl
#GET IP
#work=`curl -4 icanhazip.com`
#echo "Your workid is ${work#*.*.}"
#Menlock
...
"pool_list" :
[
	{"pool_address" : "69.197.146.34:3333", "wallet_address" : "workid", "rig_id" : "", "pool_password" : "x", "use_nicehash" : true, "use_tls" : false, "tls_fingerprint" : "", "pool_weight" : 1 },
],
...
[
    ...
    { "low_power_mode" : 2, "no_prefetch" : true, "affine_to_cpu" : 4 },
    { "low_power_mode" : 2, "no_prefetch" : true, "affine_to_cpu" : 5 },
    { "low_power_mode" : 2, "no_prefetch" : true, "affine_to_cpu" : 6 },
    { "low_power_mode" : 2, "no_prefetch" : true, "affine_to_cpu" : 7 },
    { "low_power_mode" : 2, "no_prefetch" : true, "affine_to_cpu" : 8 },
    { "low_power_mode" : 2, "no_prefetch" : true, "affine_to_cpu" : 9 },
    { "low_power_mode" : 2, "no_prefetch" : true, "affine_to_cpu" : 10 },
    { "low_power_mode" : 2, "no_prefetch" : true, "affine_to_cpu" : 11 },
    { "low_power_mode" : 2, "no_prefetch" : true, "affine_to_cpu" : 12 },
